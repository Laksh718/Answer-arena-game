...
function createSlot3(ownerName) {
  ...
  const Slot22 = React21.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime11.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React21.isValidElement(newElement) ? React21.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function useComposedRefs2(...refs) {
  return React26.useCallback(composeRefs4(...refs), refs);
}
...
function createSlot4(ownerName) {
  ...
  const Slot22 = React28.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime15.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React28.isValidElement(newElement) ? React28.cloneElement(newElement, void 0, newChildren) : null });
    }
...
var useLayoutEffect24 = (globalThis == null ? void 0 : globalThis.document) ? React32.useLayoutEffect : () => {
};
...
var Portal = React35.forwardRef((props, forwardedRef) => {
  ...
  return container ? import_react_dom2.default.createPortal((0, import_jsx_runtime18.jsx)(Primitive2.div, { ...portalProps, ref: forwardedRef }), container) : null;
});
...
var RemoveScroll = React37.forwardRef(function(props, parentRef) {
  ...
  return React37.createElement(
    React37.Fragment,
    null,
    enabled && React37.createElement(SideCar, { sideCar: effectCar, removeScrollBar, shards, noIsolation, inert, setCallbacks, allowPinchZoom: !!allowPinchZoom, lockRef: ref, gapMode }),
...
function RemoveScrollSideCar(props) {
  ...
  var Style = React38.useState(styleSingleton)[0];
...
var MenuPortal = (props) => {
  ...
  return (0, import_jsx_runtime19.jsx)(PortalProvider, { scope: __scopeMenu, forceMount, children: (0, import_jsx_runtime19.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime19.jsx)(Portal, { asChild: true, container, children }) }) });
};
...
var MenuContent = React40.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime19.jsx)(Collection.Provider, { scope: props.__scopeMenu, children: (0, import_jsx_runtime19.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime19.jsx)(Collection.Slot, { scope: props.__scopeMenu, children: rootContext.modal ? (0, import_jsx_runtime19.jsx)(MenuRootContentModal, { ...contentProps, ref: forwardedRef }) : (0, import_jsx_runtime19.jsx)(MenuRootContentNonModal, { ...contentProps, ref: forwardedRef }) }) }) });
  }
);
...
var MenuGroup = React40.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime19.jsx)(Primitive2.div, { role: "group", ...groupProps, ref: forwardedRef });
  }
);
...
var MenuLabel = React40.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime19.jsx)(Primitive2.div, { ...labelProps, ref: forwardedRef });
  }
);
...
var MenuSubContent = React40.forwardRef(
  (props, forwardedRef) => {
    ...
    const ref = React40.useRef(null);
    const composedRefs = useComposedRefs(forwardedRef, ref);
    return (0, import_jsx_runtime19.jsx)(Collection.Provider, { scope: props.__scopeMenu, children: (0, import_jsx_runtime19.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime19.jsx)(Collection.Slot, { scope: props.__scopeMenu, children: (0, import_jsx_runtime19.jsx)(
      MenuContentImpl,
      {
...
var useReactId2 = React41[" useId ".trim().toString()] || (() => void 0);
var count3 = 0;
...
var DropdownMenu = (props) => {
  ...
  return (0, import_jsx_runtime20.jsx)(
    DropdownMenuProvider,
    {
      ...
      modal,
      children: (0, import_jsx_runtime20.jsx)(Root3, { ...menuScope, open, onOpenChange: setOpen, dir, modal, children })
    }
  );
};
